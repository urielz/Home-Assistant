...
$robot_log = 'http://192.168.0.19:3001/vacuum.log'; # Could also be HTTPS, or mop.log
...
$map_width = 1000; # Ensure overlay and wall images match this size
...
$x_scale=0.79; # Allows scaling of roomba x lines
$y_scale=0.79; # Allows scaling of roomba y lines
$ha_rest980 = 'https://192.168.0.19:3005/api/states/sensor.rest980'; # sensor.rest980_2, if configured for Mop
$ha_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiIzNDZlMTNiZmJkNzg0NTAyYjQ5OTRkYzE4ZjQ1YzlkOSIsImlhdCI6MTYzMDM1MDIxNCwiZXhwIjoxOTQ1NzEwMjE0fQ.DWw3WMnmMbobhnnKVjO-l2YACWMFpI2tJd8az85SGeM';
$ha_timezone = 'America/Halifax'; # Supported Timezones https://www.php.net/manual/en/timezones.php
...
//
$path_opacity = 0.25; # Opacity of Roomba path --> 0.0 = completely transparent, 1.0 = completely opaque
//
///////////////////////////////////////////////////////////////////
